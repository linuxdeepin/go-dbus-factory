// Code generated by "./generator com.deepin.daemon.grub2"; DO NOT EDIT.
...
type Grub2 interface {
	grub2 // interface com.deepin.daemon.Grub2
	proxy.Object
}

type objectGrub2 struct {
	interfaceGrub2 // interface com.deepin.daemon.Grub2
	proxy.ImplObject
}

func NewGrub2(conn *dbus.Conn) Grub2 {
	obj := new(objectGrub2)
	obj.ImplObject.Init_(conn, "com.deepin.daemon.Grub2", "/com/deepin/daemon/Grub2")
	return obj
}
