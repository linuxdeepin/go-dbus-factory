...
type Uadp interface {
	uadp // interface org.deepin.daemon.Uadp1
	proxy.Object
}

type objectUadp struct {
	interfaceUadp // interface org.deepin.daemon.Uadp1
	proxy.ImplObject
}

func NewUadp(conn *dbus.Conn) Uadp {
	obj := new(objectUadp)
	obj.ImplObject.Init_(conn, "org.deepin.daemon.Uadp1", "/org/deepin/daemon/Uadp1")
	return obj
}
...
func (*interfaceUadp) GetInterfaceName_() string {
	return "org.deepin.daemon.Uadp1"
}
