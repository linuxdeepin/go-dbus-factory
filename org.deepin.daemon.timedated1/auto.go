// Code generated by "./generator org.deepin.daemon.timedated1"; DO NOT EDIT.
...
type Timedated interface {
	timedated // interface org.deepin.daemon.Timedated1
	proxy.Object
}

type objectTimedated struct {
	interfaceTimedated // interface org.deepin.daemon.Timedated1
	proxy.ImplObject
}

func NewTimedated(conn *dbus.Conn) Timedated {
	obj := new(objectTimedated)
	obj.ImplObject.Init_(conn, "org.deepin.daemon.Timedated1", "/org/deepin/daemon/Timedated1")
	return obj
}
...
func (*interfaceTimedated) GetInterfaceName_() string {
	return "org.deepin.daemon.Timedated1"
}
