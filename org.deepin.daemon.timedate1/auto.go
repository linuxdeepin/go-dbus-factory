// Code generated by "./generator org.deepin.daemon.timedate1"; DO NOT EDIT.
...
type Timedate interface {
	timedate // interface org.deepin.daemon.Timedate1
	proxy.Object
}

type objectTimedate struct {
	interfaceTimedate // interface org.deepin.daemon.Timedate1
	proxy.ImplObject
}

func NewTimedate(conn *dbus.Conn) Timedate {
	obj := new(objectTimedate)
	obj.ImplObject.Init_(conn, "org.deepin.daemon.Timedate1", "/org/deepin/daemon/Timedate1")
	return obj
}
...
func (*interfaceTimedate) GetInterfaceName_() string {
	return "org.deepin.daemon.Timedate1"
}
