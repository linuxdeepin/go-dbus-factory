// Code generated by "./generator org.deepin.daemon.sessionwatcher1"; DO NOT EDIT.
...
type SessionWatcher interface {
	sessionWatcher // interface org.deepin.daemon.SessionWatcher1
	proxy.Object
}

type objectSessionWatcher struct {
	interfaceSessionWatcher // interface org.deepin.daemon.SessionWatcher1
	proxy.ImplObject
}

func NewSessionWatcher(conn *dbus.Conn) SessionWatcher {
	obj := new(objectSessionWatcher)
	obj.ImplObject.Init_(conn, "org.deepin.daemon.SessionWatcher1", "/org/deepin/daemon/SessionWatcher1")
	return obj
}
...
func (*interfaceSessionWatcher) GetInterfaceName_() string {
	return "org.deepin.daemon.SessionWatcher1"
}
