...
func (v *MockInterfaceConfigManager) GoEnableVerboseLogging(flags dbus.Flags, ch chan *dbus.Call) *dbus.Call {
...
func (v *MockInterfaceConfigManager) EnableVerboseLogging(flags dbus.Flags) error {
...
func (v *MockInterfaceConfigManager) GoDisableVerboseLogging(flags dbus.Flags, ch chan *dbus.Call) *dbus.Call {
	mockArgs := v.Called(flags, ch)
...
func (v *MockInterfaceConfigManager) DisableVerboseLogging(flags dbus.Flags) error {
	mockArgs := v.Called(flags)
...
func (v *MockInterfaceConfigManager) GoSetLogRules(flags dbus.Flags, ch chan *dbus.Call, rules string) *dbus.Call {
	mockArgs := v.Called(flags, ch, rules)
...
func (v *MockInterfaceConfigManager) SetLogRules(flags dbus.Flags, rules string) error {
	mockArgs := v.Called(flags, rules)
