...
type configManager interface {
	...
	GoEnableVerboseLogging(flags dbus.Flags, ch chan *dbus.Call) *dbus.Call
	EnableVerboseLogging(flags dbus.Flags) error
	GoDisableVerboseLogging(flags dbus.Flags, ch chan *dbus.Call) *dbus.Call
	DisableVerboseLogging(flags dbus.Flags) error
	GoSetLogRules(flags dbus.Flags, ch chan *dbus.Call, rules string) *dbus.Call
	SetLogRules(flags dbus.Flags, rules string) error
...
func (v *interfaceConfigManager) GoEnableVerboseLogging(flags dbus.Flags, ch chan *dbus.Call) *dbus.Call {
	return v.GetObject_().Go_(v.GetInterfaceName_()+".enableVerboseLogging", flags, ch)
}

func (v *interfaceConfigManager) EnableVerboseLogging(flags dbus.Flags) error {
	return (<-v.GoEnableVerboseLogging(flags, make(chan *dbus.Call, 1)).Done).Err
}

// method disableVerboseLogging

func (v *interfaceConfigManager) GoDisableVerboseLogging(flags dbus.Flags, ch chan *dbus.Call) *dbus.Call {
	return v.GetObject_().Go_(v.GetInterfaceName_()+".disableVerboseLogging", flags, ch)
}

func (v *interfaceConfigManager) DisableVerboseLogging(flags dbus.Flags) error {
	return (<-v.GoDisableVerboseLogging(flags, make(chan *dbus.Call, 1)).Done).Err
}

// method setLogRules

func (v *interfaceConfigManager) GoSetLogRules(flags dbus.Flags, ch chan *dbus.Call, rules string) *dbus.Call {
	return v.GetObject_().Go_(v.GetInterfaceName_()+".setLogRules", flags, ch, rules)
}

func (v *interfaceConfigManager) SetLogRules(flags dbus.Flags, rules string) error {
	return (<-v.GoSetLogRules(flags, make(chan *dbus.Call, 1), rules).Done).Err
}
