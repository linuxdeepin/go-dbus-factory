// Code generated by "./generator org.deepin.daemon.airplanemode1"; DO NOT EDIT.
...
type AirplaneMode interface {
	airplaneMode // interface org.deepin.daemon.AirplaneMode1
	proxy.Object
}

type objectAirplaneMode struct {
	interfaceAirplaneMode // interface org.deepin.daemon.AirplaneMode1
	proxy.ImplObject
}

func NewAirplaneMode(conn *dbus.Conn) AirplaneMode {
	obj := new(objectAirplaneMode)
	obj.ImplObject.Init_(conn, "org.deepin.daemon.AirplaneMode1", "/org/deepin/daemon/AirplaneMode1")
	return obj
}
...
func (*interfaceAirplaneMode) GetInterfaceName_() string {
	return "org.deepin.daemon.AirplaneMode1"
}
