// Code generated by "./generator ./org.deepin.system.power1"; DO NOT EDIT.
...
type Power interface {
	power // interface org.deepin.system.Power1
	proxy.Object
}

type objectPower struct {
	interfacePower // interface org.deepin.system.Power1
	proxy.ImplObject
}

func NewPower(conn *dbus.Conn) Power {
	obj := new(objectPower)
	obj.ImplObject.Init_(conn, "org.deepin.system.Power1", "/org/deepin/system/Power1")
	return obj
}
...
func (*interfacePower) GetInterfaceName_() string {
	return "org.deepin.system.Power1"
}
...
type Battery interface {
	battery // interface org.deepin.system.Power1.Battery
	proxy.Object
}

type objectBattery struct {
	interfaceBattery // interface org.deepin.system.Power1.Battery
	proxy.ImplObject
}
...
func NewBattery(conn *dbus.Conn, path dbus.ObjectPath) (Battery, error) {
	...
	obj.ImplObject.Init_(conn, "org.deepin.system.Power1", path)
	return obj, nil
}
...
func (*interfaceBattery) GetInterfaceName_() string {
	return "org.deepin.system.Power1.Battery"
}
