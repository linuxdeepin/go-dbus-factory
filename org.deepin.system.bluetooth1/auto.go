// Code generated by "./generator org.deepin.system.bluetooth1"; DO NOT EDIT.
...
type Bluetooth interface {
	bluetooth // interface org.deepin.system.Bluetooth1
	proxy.Object
}

type objectBluetooth struct {
	interfaceBluetooth // interface org.deepin.system.Bluetooth1
	proxy.ImplObject
}

func NewBluetooth(conn *dbus.Conn) Bluetooth {
	obj := new(objectBluetooth)
	obj.ImplObject.Init_(conn, "org.deepin.system.Bluetooth1", "/org/deepin/system/Bluetooth1")
	return obj
}
...
func (*interfaceBluetooth) GetInterfaceName_() string {
	return "org.deepin.system.Bluetooth1"
}
