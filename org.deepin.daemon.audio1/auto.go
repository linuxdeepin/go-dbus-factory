// Code generated by "./generator org.deepin.daemon.audio1"; DO NOT EDIT.
...
type Audio interface {
	audio // interface org.deepin.daemon.Audio1
	proxy.Object
}

type objectAudio struct {
	interfaceAudio // interface org.deepin.daemon.Audio1
	proxy.ImplObject
}

func NewAudio(conn *dbus.Conn) Audio {
	obj := new(objectAudio)
	obj.ImplObject.Init_(conn, "org.deepin.daemon.Audio1", "/org/deepin/daemon/Audio1")
	return obj
}
...
func (*interfaceAudio) GetInterfaceName_() string {
	return "org.deepin.daemon.Audio1"
}
...
type Sink interface {
	sink // interface org.deepin.daemon.Audio1.Sink
	proxy.Object
}

type objectSink struct {
	interfaceSink // interface org.deepin.daemon.Audio1.Sink
	proxy.ImplObject
}
...
func NewSink(conn *dbus.Conn, path dbus.ObjectPath) (Sink, error) {
	...
	obj := new(objectSink)
	obj.ImplObject.Init_(conn, "org.deepin.daemon.Audio1", path)
	return obj, nil
}
...
func (*interfaceSink) GetInterfaceName_() string {
	return "org.deepin.daemon.Audio1.Sink"
}
...
type Source interface {
	source // interface org.deepin.daemon.Audio1.Source
	proxy.Object
}

type objectSource struct {
	interfaceSource // interface org.deepin.daemon.Audio1.Source
	proxy.ImplObject
}
...
func (*interfaceSource) GetInterfaceName_() string {
	return "org.deepin.daemon.Audio1.Source"
}
...
type SinkInput interface {
	sinkInput // interface org.deepin.daemon.Audio1.SinkInput
	proxy.Object
}

type objectSinkInput struct {
	interfaceSinkInput // interface org.deepin.daemon.Audio1.SinkInput
	proxy.ImplObject
}
...
func (*interfaceSinkInput) GetInterfaceName_() string {
	return "org.deepin.daemon.Audio1.SinkInput"
}
