...
type MockAudio struct {
	MockInterfaceAudio // interface org.deepin.daemon.Audio1
	proxy.MockObject
}
...
type MockSink struct {
	MockInterfaceSink // interface org.deepin.daemon.Audio1.Sink
	proxy.MockObject
}
...
type MockSource struct {
	MockInterfaceSource // interface org.deepin.daemon.Audio1.Source
	proxy.MockObject
}
...
type MockSinkInput struct {
	MockInterfaceSinkInput // interface org.deepin.daemon.Audio1.SinkInput
	proxy.MockObject
}
