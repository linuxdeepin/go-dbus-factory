// Code generated by "./generator org.deepin.daemon.accounts1 org.deepin.daemon.airplanemode1 org.deepin.daemon.audio1 org.deepin.daemon.bluetooth1 org.deepin.daemon.daemon1 org.deepin.daemon.fprintd1 org.deepin.daemon.greeter1 org.deepin.daemon.helper.backlight1 org.deepin.daemon.powermanager1 org.deepin.daemon.sessionwatcher1 org.deepin.daemon.timedate1 org.deepin.daemon.timedated1 org.deepin.daemon.uadp1 org.deepin.daemon.uadpagent1 org.deepin.dde.clipboard1 org.deepin.lastore1 org.deepin.system.bluetooth1 org.deepin.system.bluetooth1.agent org.deepin.system.power1 org.deepin.system.systeminfo1"; DO NOT EDIT.
...
type Accounts interface {
	accounts // interface org.deepin.daemon.Accounts1
	proxy.Object
}

type objectAccounts struct {
	interfaceAccounts // interface org.deepin.daemon.Accounts1
	proxy.ImplObject
}

func NewAccounts(conn *dbus.Conn) Accounts {
	obj := new(objectAccounts)
	obj.ImplObject.Init_(conn, "org.deepin.daemon.Accounts1", "/org/deepin/daemon/Accounts1")
	return obj
}
...
func (*interfaceAccounts) GetInterfaceName_() string {
	return "org.deepin.daemon.Accounts1"
}
...
type User interface {
	user // interface org.deepin.daemon.Accounts1.User
	proxy.Object
}

type objectUser struct {
	interfaceUser // interface org.deepin.daemon.Accounts1.User
	proxy.ImplObject
}
...
func NewUser(conn *dbus.Conn, path dbus.ObjectPath) (User, error) {
	...
	obj := new(objectUser)
	obj.ImplObject.Init_(conn, "org.deepin.daemon.Accounts1", path)
	return obj, nil
}
...
func (*interfaceUser) GetInterfaceName_() string {
	return "org.deepin.daemon.Accounts1.User"
}
...
type ImageBlur interface {
	imageBlur // interface org.deepin.daemon.ImageBlur1
	proxy.Object
}

type objectImageBlur struct {
	interfaceImageBlur // interface org.deepin.daemon.ImageBlur1
	proxy.ImplObject
}

func NewImageBlur(conn *dbus.Conn) ImageBlur {
	obj := new(objectImageBlur)
	obj.ImplObject.Init_(conn, "org.deepin.daemon.Accounts1", "/org/deepin/daemon/ImageBlur1")
	return obj
}
...
func (*interfaceImageBlur) GetInterfaceName_() string {
	return "org.deepin.daemon.ImageBlur1"
}
