...
type MockAccounts struct {
	MockInterfaceAccounts // interface org.deepin.daemon.Accounts1
	proxy.MockObject
}
...
type MockUser struct {
	MockInterfaceUser // interface org.deepin.daemon.Accounts1.User
	proxy.MockObject
}
...
type MockImageBlur struct {
	MockInterfaceImageBlur // interface org.deepin.daemon.ImageBlur1
	proxy.MockObject
}
