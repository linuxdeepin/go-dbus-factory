// Code generated by "./generator org.deepin.daemon.uadpagent1"; DO NOT EDIT.
...
type UadpAgent interface {
	uadpagent // interface org.deepin.daemon.UadpAgent1
	proxy.Object
}

type objectUadpAgent struct {
	interfaceUadpagent // interface org.deepin.daemon.UadpAgent1
	proxy.ImplObject
}

func NewUadpAgent(conn *dbus.Conn) UadpAgent {
	obj := new(objectUadpAgent)
	obj.ImplObject.Init_(conn, "org.deepin.daemon.UadpAgent1", "/org/deepin/daemon/UadpAgent1")
	return obj
}
...
func (*interfaceUadpagent) GetInterfaceName_() string {
	return "org.deepin.daemon.UadpAgent1"
}
