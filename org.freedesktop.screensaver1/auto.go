// Code generated by "./generator org.freedesktop.screensaver1"; DO NOT EDIT.
...
type ScreenSaver interface {
	screenSaver // interface org.freedesktop.ScreenSaver1
	proxy.Object
}

type objectScreenSaver struct {
	interfaceScreenSaver // interface org.freedesktop.ScreenSaver1
	proxy.ImplObject
}

func NewScreenSaver(conn *dbus.Conn) ScreenSaver {
	obj := new(objectScreenSaver)
	obj.ImplObject.Init_(conn, "org.freedesktop.ScreenSaver1", "/org/freedesktop/ScreenSaver1")
	return obj
}
...
func (*interfaceScreenSaver) GetInterfaceName_() string {
	return "org.freedesktop.ScreenSaver1"
}
