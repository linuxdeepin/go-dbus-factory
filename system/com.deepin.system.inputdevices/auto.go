...
type Touchpad interface {
	touchpad // interface com.deepin.system.InputDevices.Touchpad
	proxy.Object
}

type objectTouchpad struct {
	interfaceTouchpad // interface com.deepin.system.InputDevices.Touchpad
	proxy.ImplObject
}
...
func (*interfaceTouchpad) GetInterfaceName_() string {
	return "com.deepin.system.InputDevices.Touchpad"
}
