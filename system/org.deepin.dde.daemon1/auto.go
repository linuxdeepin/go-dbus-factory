...
type Daemon interface {
	daemon // interface org.deepin.dde.Daemon1
	proxy.Object
}

type objectDaemon struct {
	interfaceDaemon // interface org.deepin.dde.Daemon1
	proxy.ImplObject
}

func NewDaemon(conn *dbus.Conn) Daemon {
	obj := new(objectDaemon)
	obj.ImplObject.Init_(conn, "org.deepin.dde.Daemon1", "/org/deepin/dde/Daemon1")
	return obj
}
...
type daemon interface {
	...
	GoSaveCustomWallPaper(flags dbus.Flags, ch chan *dbus.Call, username string, fd dbus.UnixFD, wallpaperType string) *dbus.Call
	SaveCustomWallPaper(flags dbus.Flags, username string, fd dbus.UnixFD, wallpaperType string) (string, error)
...
func (v *interfaceDaemon) GoSaveCustomWallPaper(flags dbus.Flags, ch chan *dbus.Call, username string, fd dbus.UnixFD, wallpaperType string) *dbus.Call {
	return v.GetObject_().Go_(v.GetInterfaceName_()+".SaveCustomWallPaper", flags, ch, username, fd, wallpaperType)
}
...
func (v *interfaceDaemon) SaveCustomWallPaper(flags dbus.Flags, username string, fd dbus.UnixFD, wallpaperType string) (string, error) {
	return v.StoreSaveCustomWallPaper(
		<-v.GoSaveCustomWallPaper(flags, make(chan *dbus.Call, 1), username, fd, wallpaperType).Done)
}
