...
func (v *MockInterfaceDaemon) GoSaveCustomWallPaper(flags dbus.Flags, ch chan *dbus.Call, username string, fd dbus.UnixFD, wallpaperType string) *dbus.Call {
	mockArgs := v.Called(flags, ch, username, fd, wallpaperType)
...
func (v *MockInterfaceDaemon) SaveCustomWallPaper(flags dbus.Flags, username string, fd dbus.UnixFD, wallpaperType string) (string, error) {
	mockArgs := v.Called(flags, username, fd, wallpaperType)
