...
type BiometricsDriver interface {
	biometricsDriver // interface org.deepin.dde.Authenticate1.BiometricsDriver
	proxy.Object
}

type objectBiometricsDriver struct {
	interfaceBiometricsDriver // interface org.deepin.dde.Authenticate1.BiometricsDriver
	proxy.ImplObject
}
