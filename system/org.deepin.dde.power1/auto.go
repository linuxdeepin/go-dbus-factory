...
type objectPower struct {
	interfacePower // interface org.deepin.dde.Power1
	proxy.ImplObject
}

func NewPower(conn *dbus.Conn) Power {
	obj := new(objectPower)
	obj.ImplObject.Init_(conn, "org.deepin.dde.Power1", "/org/deepin/dde/Power1")
	return obj
}
...
type power interface {
	...
	TlpMode() proxy.PropString
	ShortIdleState() proxy.PropBool
}
...
func (v *interfacePower) GoSetTlpMode(flags dbus.Flags, ch chan *dbus.Call, mode string) *dbus.Call {
	return v.GetObject_().Go_(v.GetInterfaceName_()+".SetTlpMode", flags, ch, mode)
}
...
func (v *interfacePower) TlpMode() proxy.PropString {
	return &proxy.ImplPropString{
		Impl: v,
		Name: "TlpMode",
	}
...
// property ShortIdleState b

func (v *interfacePower) ShortIdleState() proxy.PropBool {
	return &proxy.ImplPropBool{
		Impl: v,
		Name: "ShortIdleState",
	}
...
type Battery interface {
	battery // interface org.deepin.dde.Power1.Battery
	proxy.Object
}

type objectBattery struct {
	interfaceBattery // interface org.deepin.dde.Power1.Battery
	proxy.ImplObject
}
...
func NewBattery(conn *dbus.Conn, path dbus.ObjectPath) (Battery, error) {
	...
	obj.ImplObject.Init_(conn, "org.deepin.dde.Power1", path)
	return obj, nil
}
...
func (*interfaceBattery) GetInterfaceName_() string {
	return "org.deepin.dde.Power1.Battery"
}
