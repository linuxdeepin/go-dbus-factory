...
func (v *MockInterfacePower) GoSetTlpMode(flags dbus.Flags, ch chan *dbus.Call, mode string) *dbus.Call {
	mockArgs := v.Called(flags, ch, mode)
...
func (v *MockInterfacePower) SetTlpMode(flags dbus.Flags, mode string) error {
	mockArgs := v.Called(flags, mode)
...
func (v *MockInterfacePower) TlpMode() proxy.PropString {
	mockArgs := v.Called()
...
func (v *MockInterfacePower) ShortIdleState() proxy.PropBool {
	mockArgs := v.Called()
