...
type IPWatchD interface {
	ipwatchd // interface org.deepin.dde.IPWatchD1
	proxy.Object
}

type objectIPWatchD struct {
	interfaceIpwatchd // interface org.deepin.dde.IPWatchD1
	proxy.ImplObject
}

func NewIPWatchD(conn *dbus.Conn) IPWatchD {
	obj := new(objectIPWatchD)
	obj.ImplObject.Init_(conn, "org.deepin.dde.IPWatchD1", "/org/deepin/dde/IPWatchD1")
	return obj
}
...
func (*interfaceIpwatchd) GetInterfaceName_() string {
	return "org.deepin.dde.IPWatchD1"
}
