...
func (v *MockInterfaceSensorProxy) GoClaimProximity(flags dbus.Flags, ch chan *dbus.Call) *dbus.Call {
	mockArgs := v.Called(flags, ch)
...
func (v *MockInterfaceSensorProxy) ClaimProximity(flags dbus.Flags) error {
	mockArgs := v.Called(flags)
...
func (v *MockInterfaceSensorProxy) GoReleaseProximity(flags dbus.Flags, ch chan *dbus.Call) *dbus.Call {
	mockArgs := v.Called(flags, ch)
...
func (v *MockInterfaceSensorProxy) ReleaseProximity(flags dbus.Flags) error {
	mockArgs := v.Called(flags)
...
func (v *MockInterfaceSensorProxy) HasProximity() proxy.PropBool {
	mockArgs := v.Called()
...
func (v *MockInterfaceSensorProxy) ProximityNear() proxy.PropBool {
	mockArgs := v.Called()
