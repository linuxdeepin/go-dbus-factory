...
type MockApps struct {
	MockInterfaceDesktopFileWatcher // interface org.deepin.dde.Apps1.DesktopFileWatcher
	MockInterfaceLaunchedRecorder   // interface org.deepin.dde.Apps1.LaunchedRecorder
	proxy.MockObject
}
