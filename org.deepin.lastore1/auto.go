// Code generated by "./generator ./org.deepin.lastore1"; DO NOT EDIT.
...
type Lastore interface {
	Manager() manager // interface org.deepin.lastore1.Manager
	Updater() updater // interface org.deepin.lastore1.Updater
	proxy.Object
}

type objectLastore struct {
	interfaceManager // interface org.deepin.lastore1.Manager
	interfaceUpdater // interface org.deepin.lastore1.Updater
	proxy.ImplObject
}

func NewLastore(conn *dbus.Conn) Lastore {
	obj := new(objectLastore)
	obj.ImplObject.Init_(conn, "org.deepin.lastore1", "/org/deepin/lastore1")
	return obj
}
...
type Job interface {
	job // interface org.deepin.lastore1.Job
	proxy.Object
}

type objectJob struct {
	interfaceJob // interface org.deepin.lastore1.Job
	proxy.ImplObject
}
...
func NewJob(conn *dbus.Conn, path dbus.ObjectPath) (Job, error) {
	...
	obj := new(objectJob)
	obj.ImplObject.Init_(conn, "org.deepin.lastore1", path)
	return obj, nil
}
