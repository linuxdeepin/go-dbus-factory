...
type MockLastore struct {
	MockInterfaceManager // interface org.deepin.lastore1.Manager
	MockInterfaceUpdater // interface org.deepin.lastore1.Updater
	proxy.MockObject
}
...
type MockJob struct {
	MockInterfaceJob // interface org.deepin.lastore1.Job
	proxy.MockObject
}
