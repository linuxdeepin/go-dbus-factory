// Code generated by "./generator ./org.deepin.daemon.fprintd1"; DO NOT EDIT.
...
type Fprintd interface {
	fprintd // interface org.deepin.daemon.Fprintd1
	proxy.Object
}

type objectFprintd struct {
	interfaceFprintd // interface org.deepin.daemon.Fprintd1
	proxy.ImplObject
}

func NewFprintd(conn *dbus.Conn) Fprintd {
	obj := new(objectFprintd)
	obj.ImplObject.Init_(conn, "org.deepin.daemon.Fprintd1", "/org/deepin/daemon/Fprintd1")
	return obj
}
...
func (*interfaceFprintd) GetInterfaceName_() string {
	return "org.deepin.daemon.Fprintd1"
}
...
type Device interface {
	device // interface org.deepin.daemon.Fprintd1.Device
	proxy.Object
}

type objectDevice struct {
	interfaceDevice // interface org.deepin.daemon.Fprintd1.Device
	proxy.ImplObject
}
...
func NewDevice(conn *dbus.Conn, path dbus.ObjectPath) (Device, error) {
	...
	obj.ImplObject.Init_(conn, "org.deepin.daemon.Fprintd1", path)
	return obj, nil
}
...
func (*interfaceDevice) GetInterfaceName_() string {
	return "org.deepin.daemon.Fprintd1.Device"
}
