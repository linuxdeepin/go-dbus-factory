// Code generated by "./generator ./session/org.deepin.dde.xeventmonitor1"; DO NOT EDIT.

// SPDX-FileCopyrightText: 2018 - 2023 UnionTech Software Technology Co., Ltd.
//
// SPDX-License-Identifier: GPL-3.0-or-later
package xeventmonitor1
...
type XEventMonitor interface {
	xEventMonitor // interface org.deepin.dde.XEventMonitor1
	proxy.Object
}

type objectXEventMonitor struct {
	interfaceXEventMonitor // interface org.deepin.dde.XEventMonitor1
	proxy.ImplObject
}

func NewXEventMonitor(conn *dbus.Conn) XEventMonitor {
	obj := new(objectXEventMonitor)
	obj.ImplObject.Init_(conn, "org.deepin.dde.XEventMonitor1", "/org/deepin/dde/XEventMonitor1")
	return obj
}
