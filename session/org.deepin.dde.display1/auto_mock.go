...
type MockPropTouchscreensV2 struct {
	mock.Mock
}

func (p MockPropTouchscreensV2) Get(flags dbus.Flags) (value []TouchscreenV2, err error) {
	args := p.Called(flags)

	var ok bool
	value, ok = args.Get(0).([]TouchscreenV2)
	if !ok {
		panic(fmt.Sprintf("assert: arguments: %d failed because object wasn't correct type: %v", 0, args.Get(0)))
	}
...
func (p MockPropTouchscreensV2) Set(flags dbus.Flags, value []TouchscreenV2) error {
	args := p.Called(flags, value)

	return args.Error(0)
}

func (p MockPropTouchscreensV2) ConnectChanged(cb func(hasValue bool, value []TouchscreenV2)) error {
	args := p.Called(cb)
...
func (v *MockInterfaceDisplay) TouchscreensV2() PropTouchscreensV2 {
	mockArgs := v.Called()

	ret0, ok := mockArgs.Get(0).(*MockPropTouchscreensV2)
	if !ok {
		panic(fmt.Sprintf("assert: arguments: %d failed because object wasn't correct type: %v", 0, mockArgs.Get(0)))
	}
...
type MockMonitor struct {
	MockInterfaceMonitor // interface org.deepin.dde.Display1.Monitor
	proxy.MockObject
}
