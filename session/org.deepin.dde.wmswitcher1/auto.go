...
type WMSwitcher interface {
	wmSwitcher // interface org.deepin.dde.WMSwitcher1
	proxy.Object
}

type objectWMSwitcher struct {
	interfaceWmSwitcher // interface org.deepin.dde.WMSwitcher1
	proxy.ImplObject
}

func NewWMSwitcher(conn *dbus.Conn) WMSwitcher {
	obj := new(objectWMSwitcher)
	obj.ImplObject.Init_(conn, "org.deepin.dde.WMSwitcher1", "/org/deepin/dde/WMSwitcher1")
	return obj
}
