...
type MockMouse struct {
	MockInterfaceMouse // interface org.deepin.dde.InputDevice1.Mouse
	proxy.MockObject
}

type MockInterfaceMouse struct {
	mock.Mock
}

// method Enable

func (v *MockInterfaceMouse) GoEnable(flags dbus.Flags, ch chan *dbus.Call, enabled bool) *dbus.Call {
...
func (v *MockInterfaceMouse) Enable(flags dbus.Flags, enabled bool) error {
...
func (v *MockInterfaceMouse) GoReset(flags dbus.Flags, ch chan *dbus.Call) *dbus.Call {
	mockArgs := v.Called(flags, ch)
...
func (v *MockInterfaceMouse) Reset(flags dbus.Flags) error {
	mockArgs := v.Called(flags)
...
func (v *MockInterfaceMouse) DeviceList() proxy.PropString {
	mockArgs := v.Called()
...
func (v *MockInterfaceMouse) Enabled() proxy.PropBool {
	mockArgs := v.Called()
...
func (v *MockInterfaceMouse) NaturalScroll() proxy.PropBool {
	mockArgs := v.Called()
...
func (v *MockInterfaceMouse) MiddleButtonEmulation() proxy.PropBool {
	mockArgs := v.Called()
...
func (v *MockInterfaceMouse) AdaptiveAccelProfile() proxy.PropBool {
	mockArgs := v.Called()
...
func (v *MockInterfaceMouse) MotionThreshold() proxy.PropDouble {
	mockArgs := v.Called()
...
func (v *MockInterfaceMouse) DoubleClick() proxy.PropInt32 {
	mockArgs := v.Called()
...
func (v *MockInterfaceMouse) DragThreshold() proxy.PropInt32 {
	mockArgs := v.Called()
...
func (v *MockInterfaceMouse) Exist() proxy.PropBool {
	mockArgs := v.Called()
...
func (v *MockInterfaceMouse) LeftHanded() proxy.PropBool {
	mockArgs := v.Called()
...
func (v *MockInterfaceMouse) DisableTpad() proxy.PropBool {
	mockArgs := v.Called()
...
func (v *MockInterfaceMouse) MotionAcceleration() proxy.PropDouble {
	mockArgs := v.Called()
...
func (v *MockInterfaceMouse) MotionScaling() proxy.PropDouble {
	mockArgs := v.Called()
