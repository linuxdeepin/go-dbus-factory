...
type Keyboard interface {
	keyboard // interface org.deepin.dde.InputDevice1.Keyboard
	proxy.Object
}

type objectKeyboard struct {
	interfaceKeyboard // interface org.deepin.dde.InputDevice1.Keyboard
	proxy.ImplObject
}

func NewKeyboard(conn *dbus.Conn) Keyboard {
	obj := new(objectKeyboard)
	obj.ImplObject.Init_(conn, "org.deepin.dde.InputDevices1", "/org/deepin/dde/InputDevice1/Keyboard")
	return obj
}
...
type TouchPad interface {
	touchPad // interface org.deepin.dde.InputDevice1.TouchPad
	proxy.Object
}

type objectTouchPad struct {
	interfaceTouchPad // interface org.deepin.dde.InputDevice1.TouchPad
	proxy.ImplObject
}

func NewTouchPad(conn *dbus.Conn) TouchPad {
	obj := new(objectTouchPad)
	obj.ImplObject.Init_(conn, "org.deepin.dde.InputDevices1", "/org/deepin/dde/InputDevice1/TouchPad")
	return obj
}
...
func (*interfaceTouchPad) GetInterfaceName_() string {
	return "org.deepin.dde.InputDevice1.TouchPad"
}
...
type Mouse interface {
	mouse // interface org.deepin.dde.InputDevice1.Mouse
	proxy.Object
}

type objectMouse struct {
	interfaceMouse // interface org.deepin.dde.InputDevice1.Mouse
	proxy.ImplObject
}

func NewMouse(conn *dbus.Conn) Mouse {
	obj := new(objectMouse)
	obj.ImplObject.Init_(conn, "org.deepin.dde.InputDevices1", "/org/deepin/dde/InputDevice1/Mouse")
	return obj
}
...
type mouse interface {
	...
	NaturalScroll() proxy.PropBool
	MiddleButtonEmulation() proxy.PropBool
	AdaptiveAccelProfile() proxy.PropBool
	MotionThreshold() proxy.PropDouble
	DoubleClick() proxy.PropInt32
	DragThreshold() proxy.PropInt32
	Exist() proxy.PropBool
	LeftHanded() proxy.PropBool
	DisableTpad() proxy.PropBool
	MotionAcceleration() proxy.PropDouble
	MotionScaling() proxy.PropDouble
}

type interfaceMouse struct{}

func (v *interfaceMouse) GetObject_() *proxy.ImplObject {
	return (*proxy.ImplObject)(unsafe.Pointer(v))
}

func (*interfaceMouse) GetInterfaceName_() string {
	return "org.deepin.dde.InputDevice1.Mouse"
}

// method Enable

func (v *interfaceMouse) GoEnable(flags dbus.Flags, ch chan *dbus.Call, enabled bool) *dbus.Call {
	return v.GetObject_().Go_(v.GetInterfaceName_()+".Enable", flags, ch, enabled)
}

func (v *interfaceMouse) Enable(flags dbus.Flags, enabled bool) error {
	return (<-v.GoEnable(flags, make(chan *dbus.Call, 1), enabled).Done).Err
}

// method Reset

func (v *interfaceMouse) GoReset(flags dbus.Flags, ch chan *dbus.Call) *dbus.Call {
	return v.GetObject_().Go_(v.GetInterfaceName_()+".Reset", flags, ch)
}

func (v *interfaceMouse) Reset(flags dbus.Flags) error {
	return (<-v.GoReset(flags, make(chan *dbus.Call, 1)).Done).Err
}

// property DeviceList s

func (v *interfaceMouse) DeviceList() proxy.PropString {
	return &proxy.ImplPropString{
		Impl: v,
		Name: "DeviceList",
	}
...
func (v *interfaceMouse) Enabled() proxy.PropBool {
	return &proxy.ImplPropBool{
		Impl: v,
		Name: "Enabled",
	}
...
func (v *interfaceMouse) NaturalScroll() proxy.PropBool {
	return &proxy.ImplPropBool{
		Impl: v,
		Name: "NaturalScroll",
	}
...
// property MiddleButtonEmulation b

func (v *interfaceMouse) MiddleButtonEmulation() proxy.PropBool {
	return &proxy.ImplPropBool{
		Impl: v,
		Name: "MiddleButtonEmulation",
	}
}

// property AdaptiveAccelProfile b

func (v *interfaceMouse) AdaptiveAccelProfile() proxy.PropBool {
	return &proxy.ImplPropBool{
		Impl: v,
		Name: "AdaptiveAccelProfile",
	}
}

// property MotionThreshold d

func (v *interfaceMouse) MotionThreshold() proxy.PropDouble {
	return &proxy.ImplPropDouble{
		Impl: v,
		Name: "MotionThreshold",
	}
...
func (v *interfaceMouse) DoubleClick() proxy.PropInt32 {
	return &proxy.ImplPropInt32{
		Impl: v,
		Name: "DoubleClick",
	}
...
func (v *interfaceMouse) DragThreshold() proxy.PropInt32 {
	return &proxy.ImplPropInt32{
		Impl: v,
		Name: "DragThreshold",
	}
...
func (v *interfaceMouse) Exist() proxy.PropBool {
	return &proxy.ImplPropBool{
		Impl: v,
		Name: "Exist",
	}
...
func (v *interfaceMouse) LeftHanded() proxy.PropBool {
	return &proxy.ImplPropBool{
		Impl: v,
		Name: "LeftHanded",
	}
...
// property DisableTpad b

func (v *interfaceMouse) DisableTpad() proxy.PropBool {
	return &proxy.ImplPropBool{
		Impl: v,
		Name: "DisableTpad",
	}
...
func (v *interfaceMouse) MotionAcceleration() proxy.PropDouble {
	return &proxy.ImplPropDouble{
		Impl: v,
		Name: "MotionAcceleration",
	}
...
func (v *interfaceMouse) MotionScaling() proxy.PropDouble {
	return &proxy.ImplPropDouble{
		Impl: v,
		Name: "MotionScaling",
	}
