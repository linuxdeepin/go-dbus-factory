// Code generated by "./generator ./session/org.deepin.dde.notification1"; DO NOT EDIT.
...
type Notification interface {
	notification // interface org.deepin.dde.Notification1
	proxy.Object
}

type objectNotification struct {
	interfaceNotification // interface org.deepin.dde.Notification1
	proxy.ImplObject
}

func NewNotification(conn *dbus.Conn) Notification {
	obj := new(objectNotification)
	obj.ImplObject.Init_(conn, "org.deepin.dde.Osd1", "/org/deepin/dde/Notification1")
	return obj
}
...
func (*interfaceNotification) GetInterfaceName_() string {
	return "org.deepin.dde.Notification1"
}
